...
PAPER_ZT = {
    "OHD":               (1.310, 0.05),
    "OHD_PP":            (0.650, 0.04),
    "OHD_PP_SH0ES":      (0.330, 0.04),
    "OHD_PP_SH0ES_DESI": (0.310, 0.04),
}

SH0ES_H0, SH0ES_ERR   = 73.27, 1.04
...
axes6[1].bar(x6, ages_m, yerr=ages_e,
              ...
              ecolor='black')
axes6[1].axhline(13.81, color='red',
                  ls='--', lw=1.8,
                  label='Planck 13.81 Gyr')
axes6[1].axhspan(13.81-0.038, 13.81+0.038,
